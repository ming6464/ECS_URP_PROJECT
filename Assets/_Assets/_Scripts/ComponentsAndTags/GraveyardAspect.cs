using _Assets._Scripts.AuthoringAndMono;
using _Assets._Scripts.Math;
using Unity.Entities;
using Unity.Mathematics;
using Unity.Transforms;

namespace _Assets._Scripts.ComponentsAndTags
{
    ...
    public readonly partial struct GraveyardAspect : IAspect
    {
        ...
        private float3 MinCorner => new float3(_graveyardRandom.ValueRO.XMinMax.x,_graveyardRandom.ValueRO.ZMinMax.x,_graveyardRandom.ValueRO.ZMinMax.x);
        private float3 MaxCorner => new float3(_graveyardRandom.ValueRO.XMinMax.y,_graveyardRandom.ValueRO.YMinMax.y,_graveyardRandom.ValueRO.ZMinMax.y);
    }
}